<%@ Page Inherits="AdminDashboardView" MasterPageFile="~/Views/Shared/Admin.Master"%>
...
<h2 class="title"><%= Resources.Strings.AdminDashboardTitle %></h2>
<div id="dashboard">
        <ul id="data">
            <li id="recentPosts">
                <h3><%= Resources.Strings.RecentPosts %></h3>
                <%= this.RenderPartial().Using<PostListSmall>().ForEachOf(Model.Posts) %>
                
            </li>
           <li id="recentComments">
                <h3><%= Resources.Strings.RecentComments %></h3>
