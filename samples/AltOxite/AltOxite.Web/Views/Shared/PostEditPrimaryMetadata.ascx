<%@ Control Language="C#" AutoEventWireup="true" Inherits="PostEditPrimaryMetaData" %>
<div class="admin metadata">
<ul class="single">
    <li class="input tags">
        <label for="post_tags">Tags</label>
        <%= this.TextBoxFor(m => m.Tags).ElementId("post_tags").Class("text").WithHint("Enter comma seperated list of tags...") %>
    </li>
</ul>
